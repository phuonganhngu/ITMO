...
HD_PWD='C:/Users/Arsenii/Desktop/ITMO/Schemota/Vivado/Lab2NEW/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cube_root.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cube_root.tcl -notrace

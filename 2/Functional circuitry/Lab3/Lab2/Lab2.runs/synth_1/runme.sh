...
HD_PWD='C:/Users/Arsenii/Desktop/ITMO/Schemota/Vivado/Lab2NEW/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cube_root.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cube_root.tcl

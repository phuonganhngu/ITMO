...
HD_PWD='D:/tmp/test_ctr/test_ctr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_ctr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_ctr.tcl -notrace

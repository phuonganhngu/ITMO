...
HD_PWD='D:/tmp/test_ctr/test_ctr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_ctr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_ctr.tcl
